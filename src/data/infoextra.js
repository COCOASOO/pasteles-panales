export const infoExtraProductos = [
  {
    id: 1,
    nombre: 'Caramelo',
    ...
    comoHacer: {
      ...
      pasos: [
        "Paso 1: Prepara los pañales",
        "Paso 2: Forma la base del caramelo",
        "Paso 3: Añade decoraciones",
        "Paso 4: Finaliza con un toque personal"
      ]
    },
    ideasAdicionales: [
      "Personaliza con colores temáticos",
      "Añade pequeños juguetes o accesorios",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      pasos: [
        "Armar las ruedas con pañales enrollados",
        "Ensamblar la estructura de la moto",
        "Llenar los compartimentos con regalos",
        "Decorar con mucho cariño"
      ]
    },
    porQueRegalar: "Una moto de pañales es el regalo perfecto para dar la bienvenida a un nuevo bebé. Es práctico y encantador a la vez, sorprendiendo a todos con su originalidad. No solo es visualmente atractivo, sino que también está lleno de cosas útiles para el bebé y los papás. Su creatividad lo convierte en el centro de atención en cualquier celebración de bebé.",
    ventajas: [
      "Es un regalo práctico y encantador",
      "Combina utilidad con un diseño creativo",
      "Destaca por su originalidad",
      "Contiene múltiples regalos en uno solo",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      pasos: [
        "Paso 1: Prepara los pañales",
        "Paso 2: Forma la estructura de la batería",
        "Paso 3: Añade detalles musicales",
        "Paso 4: Finaliza con toques personalizados"
      ]
    },
    ideasAdicionales: [
      "Incluye pequeños instrumentos musicales de juguete",
      "Usa colores vibrantes para simular una batería real",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      materiales: [
        "Pañales desechables (preferiblemente del mismo tamaño)",
        "Una base para tartas",
        "Ligas elásticas o cintas para atar los pañales",
        "Elementos decorativos (cintas, lazos, peluches pequeños, chupetes, etc.)",
        "Cinta adhesiva",
        "Tijeras",
        "Cartulina o tarjetas decorativas (opcional)",
        "Pegamento (opcional)"
      ],
      pasos: [
        "Prepara la base: Coloca la base sobre una superficie plana y limpia.",
        "Enrolla los pañales: Toma un pañal y enróllalo desde la parte abierta hacia la parte cerrada.",
        "Crea la primera capa: Coloca los pañales enrollados alrededor del borde de la base, formando un círculo.",
        "Construye las capas superiores: Repite el proceso con los pañales para crear varias capas.",
        "Decora la tarta: Una vez que todas las capas estén en su lugar, comienza a decorar la tarta.",
        "Añade los toques finales: Puedes escribir un mensaje especial en una tarjeta decorativa y colocarla en la tarta."
      ]
    },
  ...
  },
  {
    ...
    comoHacer: {
      ...
      pasos: [
        "Paso 1: Prepara la base sólida",
        "Paso 2: Forma el primer y segundo piso",
        "Paso 3: Añade el tercer piso",
        "Paso 4: Decora cada nivel y finaliza"
      ]
    },
    ideasAdicionales: [
      "Crea un tema que se desarrolle a lo largo de los tres pisos",
      "Usa cintas o telas para unificar los niveles",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      materiales: [
        "Pañales desechables (preferiblemente del mismo tamaño)",
        "Una base sólida para el castillo (como un cartón grande, una bandeja, una tabla de cortar, etc.)",
        "Cinta adhesiva o ligas elásticas para unir los pañales",
        "Elementos decorativos (como torres de cartón, banderines, adornos de princesa o caballero, etc.)",
        "Tijeras",
        "Cartulina o papel de construcción (opcional)",
        "Pegamento (opcional)"
      ]
    },
    conclusion: "En pasteles de pañales, nos esforzamos por ofrecer tartas de pañales de la más alta calidad. Nuestros diseños personalizados aseguran que cada tarta sea una expresión única de amor y celebración.",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      pasos: [
        ...
        "Montar la estructura del carrito",
        "Añadir los regalos en el interior",
        "Decorar con mucho cariño"
      ]
    },
    porQueRegalar: "Un cochecito de pañales es el regalo perfecto para dar la bienvenida a un nuevo bebé. Es práctico y adorable, sorprendiendo a todos con su originalidad. No solo es visualmente atractivo, sino que también está lleno de regalos útiles para el bebé y los padres. Su creatividad lo convierte en el centro de atención en cualquier fiesta de bienvenida.",
    ventajas: [
      "Es un regalo completo y útil",
      "Combina practicidad con un diseño creativo",
  ...
  },
  {
    ...
    comoHacer: {
      ...
      materiales: [
        "Pañales desechables",
        "Una base sólida para el coche",
        "Elementos decorativos",
        "Accesorios para bebé",
        "Cinta adhesiva o ligas elásticas",
        "Tijeras"
      ],
      pasos: [
        "Preparar la base del coche",
        "Formar la estructura con pañales",
        "Añadir detalles del coche (ruedas, manillar, etc.)",
        "Decorar y añadir accesorios"
      ]
    },
  ...
  },
  {
    ...
    comoHacer: {
      ...
      pasos: [
        "Crear la forma básica de la guitarra con una base sólida",
        "Cubrir la base con pañales para formar el cuerpo de la guitarra",
        "Añadir detalles como cuerdas, clavijas y puente",
        "Decorar con elementos musicales y accesorios para bebé"
      ]
    },
  ...
  },
  {
    ...
    comoHacer: {
      ...
      materiales: [
        "Pañales desechables",
        "Una base en forma de raqueta de pádel",
        "Elementos decorativos relacionados con el pádel",
        "Accesorios para bebé",
        "Cinta adhesiva o ligas elásticas",
        "Tijeras"
      ],
      pasos: [
        "Crear la forma básica de la raqueta con una base sólida",
        "Cubrir la base con pañales para formar el cuerpo de la raqueta",
        "Añadir detalles como el mango y el marco",
        "Decorar con elementos relacionados con el pádel y accesorios para bebé"
      ]
    },
  ...
  },
  {
    ...
    comoHacer: {
      ...
      materiales: [
        "Pañales desechables",
        "Una base sólida",
        "Elementos decorativos relacionados con las artes marciales",
        "Accesorios para bebé",
        "Cinta adhesiva o ligas elásticas",
        "Tijeras"
      ],
      pasos: [
        "Crear la estructura base con pañales",
        "Formar elementos característicos de las artes marciales (como un tatami o un cinturón)",
        "Añadir detalles temáticos",
        "Decorar con accesorios para bebé y elementos de artes marciales"
      ]
    },
